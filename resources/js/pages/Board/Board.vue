<template>
  <v-container>
    <v-row>
      <v-col cols="3">
        <v-card tile flat color="secondary" class="px-2 d-flex justify-space-between">
          <h2 class="font-weight-light">COMING</h2>
          <div class="my-auto">
      ...
      <v-col cols="3">
        <v-card tile flat color="secondary" class="px-2 d-flex justify-space-between">
          <h2 class="font-weight-light">TO DO</h2>
          <div class="my-auto">
          <add-task v-if="user"></add-task>
          </div>
        </v-card>
      ...
      <v-col cols="3">
        <v-card tile flat color="secondary" class="px-2">
          <h2 class="font-weight-light">FINISHED</h2>
        </v-card>
      </v-col>

      <v-col cols="3">
        <v-card tile flat color="secondary" class="px-2">
          <h2 class="font-weight-light">CANCELED</h2>
        </v-card>
      </v-col>
